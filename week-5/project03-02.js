...
// create htmlCode var to store the contents produced by the for loop
let htmlCode = "";

// for loop to run through all the captions
for (let i = 0; i < captions.length; i++) {
  // put the desired html code in the htmlCode var for use later on.
  htmlCode += "<figure>"
            + "<img alt='' src='slide"+i+".jpg' />"
            + "<figcaption>"+captions[i]+"</figcaption></figure>";
}

// show the generated htmlCode in the gallery element on the page.
